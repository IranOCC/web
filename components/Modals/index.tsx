...
export default function Modal({ path, open, setOpen, title, children, footerButton, closeButton = true, whiteClose = false, className = "" }: IProps) {
  ...
  return (
    <Transition.Root show={_open} as={Fragment}>
      <Dialog as="div" className="relative z-50" initialFocus={cancelButtonRef} onClose={openHandler}>
        ...
        <div className="fixed inset-0 z-10 overflow-y-auto">
          <div className="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
            ...
            >
              <Dialog.Panel className={"relative transform overflow-hidden rounded-lg bg-white text-left shadow-xl transition-all w-full sm:my-8 sm:w-full sm:max-w-2xl" + " " + className}>
