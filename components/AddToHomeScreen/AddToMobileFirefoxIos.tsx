...
export default function AddToMobileFirefoxIos(props: Props) {
  ...
  return (
    ...
    >
      <KeyboardDoubleArrowDown fontSize="large" className="absolute bottom-[10px] right-[5px] z-[103] animate-bounce text-secondary" />
      <ModalContent>
          ...
          <div className="flex flex-col gap-1 text-sm text-gray-500">
            ...
            <div className="flex flex-wrap items-center gap-1">
              ...
              <div dir="ltr" className="flex items-center justify-between gap-2 rounded-lg bg-gray-50 p-1 text-gray-900">
                <FiShare className="text-2xl text-blue-600" />
                <p>Share</p>
              </div>
              را بزنید
            </div>
