            ...
            {slug ? (
              <Link href={`/property/${slug}`} className="w-full">
                <div className="flex w-full flex-col gap-2 rounded-xl bg-white p-2 md:flex-row md:bg-gray-200 md:p-0">
                  ...
                  {special && (
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className="absolute left-4 top-4 h-7 w-7 text-secondary" fill="currentColor">
                      <path
                        fill="currentColor"
                  ...
                  <div className="flex w-full flex-col justify-center gap-2 md:py-3">
                    <h3 className="flex w-full flex-row gap-2 text-start font-bold">{title}</h3>
