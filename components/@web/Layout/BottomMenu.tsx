...
const WebBottomMenu = () => {
  ...
  return (
    <ClickAwayListener onClickAway={() => setOpenSub(null)}>
      <aside className={"absolute bottom-0 z-10 flex w-full flex-col items-center justify-end rounded-t-3xl bg-white px-3 py-3 transition-all md:hidden" + (openSub !== null ? " h-40" : " h-16")}>
        {openSub === 4 && (
          <>
